...
# wiki/ vs wiki1/ — 从知识库到认知操作系统

## 对比维度

| 维度 | wiki/（知识库） | wiki1/（认知操作系统） |
|------|----------------|----------------------|
...
wiki1/ 通过三层架构 + IPO 闭环 + yaml 反向校验，让 AI 从"理解驱动"转向"组装驱动"。

## 两者关系

- wiki1/ 不替代 wiki/，而是 wiki/ 的元层
- wiki1/ 通过 `source:` 字段反向指回 wiki/ 中的原始页面
- wiki/ 继续作为知识内容的存储和萃取层
- wiki1/ 提供"如何调用和组装这些知识"的规则
